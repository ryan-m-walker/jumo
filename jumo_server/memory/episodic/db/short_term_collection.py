...
short_term_episodic_memory_collection: AsyncCollection[ShortTermMemorySummary] = db['short_term_episodic_memory']
...
class ShortTermEpisodicMemoryDB:
    ...
    async def update_summary(self, id: str, summary: str):
        await short_term_episodic_memory_collection.update_one({ "_id": id }, {
            "$set": {
                "state": "processed",
                "summary": summary
            }
