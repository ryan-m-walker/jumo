...
SHORT_TERM_SUMMARY_QUEUE_SIZE = 10
...
class EpisodicMemory:
    ...
    async def process_short_term_summary_queue(self, messages: list):
        ...
        if output.type == "text":
            await short_term_episodic_memory_db.update_summary(id, output.text)
